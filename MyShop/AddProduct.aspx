<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="AddProduct.aspx.cs" Inherits="MyShop.AddProduct" %>
    ...
    <div class="container">
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:TextBox ID="textProductName" CssClass="form-control" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:TextBox ID="textPrice" CssClass="form-control" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:TextBox ID="textSellPrice" CssClass="form-control" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                <asp:Label ID="Label20" runat="server" CssClass="col-md-2 control-label" Text="Selling Quantity"></asp:Label>
                <div class="col-md-3">
                    <asp:TextBox ID="textQuantity" CssClass="form-control" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:TextBox ID="textDescription" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:TextBox ID="textPDetails" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:FileUpload ID="fileUploadImg01" CssClass="form-control" runat="server" />
                </div>
            </div>
             ...
             <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:FileUpload ID="fileUploadImg02" CssClass="form-control" runat="server" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:FileUpload ID="fileUploadImg03" CssClass="form-control" runat="server" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:FileUpload ID="fileUploadImg04" CssClass="form-control" runat="server" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:FileUpload ID="fileUploadImg05" CssClass="form-control" runat="server" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <asp:CheckBox ID="chbCOD" runat="server" />
                </div>
            </div>
