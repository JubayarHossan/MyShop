<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignIn.aspx.cs" Inherits="MyShop.SignIn" %>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorPass" runat="server" CssClass="text-danger" ErrorMessage="Please Enter Valid Password" ControlToValidate="textPass" ForeColor="Red"></asp:RequiredFieldValidator>
                        </div>
                    </div>
