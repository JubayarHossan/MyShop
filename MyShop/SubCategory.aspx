<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="SubCategory.aspx.cs" Inherits="MyShop.SubCategory" %>
                ...
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            ...
                            <asp:TextBox ID="textSubCategory" CssClass="form-control" runat="server"></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidatorSubCategoryName" runat="server" CssClass="text-danger" ErrorMessage="Plz Enter SubCategory Name" ControlToValidate="textSubCategory" ForeColor="Red"></asp:RequiredFieldValidator>
                        </div>
                    </div>
